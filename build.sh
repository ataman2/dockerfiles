...
docker build -t="bochen/storm-base:0.9.6" storm-base
docker build -t="bochen/storm-nimbus:0.9.6" storm-nimbus
docker build -t="bochen/storm-supervisor:0.9.6" storm-supervisor
docker build -t="bochen/storm-ui:0.9.6" storm-ui
